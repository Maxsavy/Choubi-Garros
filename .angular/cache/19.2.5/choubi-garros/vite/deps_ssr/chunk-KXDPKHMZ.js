...
import {
  BidiModule,
  Directionality
} from "./chunk-QGGSYPQR.js";
import {
  _CdkPrivateStyleLoader,
  _bindEventWithOptions
} from "./chunk-MYVT2RBE.js";
import {
  Platform,
  coerceElement,
  coerceNumberProperty
} from "./chunk-W4L5OEJ7.js";
import {
  DOCUMENT,
  NgTemplateOutlet
} from "./chunk-IXIDN2OZ.js";
import {
...
var MatFormFieldFloatingLabel = class _MatFormFieldFloatingLabel {
  ...
  _resizeSubscription = new import_rxjs10.Subscription();
  constructor() {
  }
  ngOnDestroy() {
    this._resizeSubscription.unsubscribe();
...
var MatFormField = class _MatFormField {
  ...
  _destroyed = new import_rxjs10.Subject();
  _isFocused = null;
  ...
  _initializeControl(previousControl) {
    ...
    this._describedByChanges?.unsubscribe();
    this._describedByChanges = control.stateChanges.pipe((0, import_operators8.startWith)([void 0, void 0]), (0, import_operators8.map)(() => [control.errorState, control.userAriaDescribedBy]), (0, import_operators8.pairwise)(), (0, import_operators8.filter)(([[prevErrorState, prevDescribedBy], [currentErrorState, currentDescribedBy]]) => {
      return prevErrorState !== currentErrorState || prevDescribedBy !== currentDescribedBy;
    })).subscribe(() => this._syncDescribedByIds());
    this._valueChanges?.unsubscribe();
    if (control.ngControl && control.ngControl.valueChanges) {
      this._valueChanges = control.ngControl.valueChanges.pipe((0, import_operators8.takeUntil)(this._destroyed)).subscribe(() => this._changeDetectorRef.markForCheck());
    }
  }
  ...
  _initializePrefixAndSuffix() {
    ...
    (0, import_rxjs10.merge)(this._prefixChildren.changes, this._suffixChildren.changes).subscribe(() => {
      this._checkPrefixAndSuffixTypes();
      this._changeDetectorRef.markForCheck();
    });
  }
  ...
  _initializeOutlineLabelOffsetSubscriptions() {
    ...
    this._dir.change.pipe((0, import_operators8.takeUntil)(this._destroyed)).subscribe(() => this._needsOutlineLabelOffsetUpdate = true);
  }
...
//# sourceMappingURL=chunk-KXDPKHMZ.js.map
