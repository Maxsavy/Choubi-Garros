...
import {
  ...
  ScrollingModule,
  ViewportRuler
} from "./chunk-WEIRLSLO.js";
import {
  ErrorStateMatcher,
  _ErrorStateTracker
} from "./chunk-2QAWVJM3.js";
import {
  FormGroupDirective,
  NgControl,
  NgForm,
  Validators
} from "./chunk-57WYB6NA.js";
import {
  A,
...
} from "./chunk-KXDPKHMZ.js";
import "./chunk-HJTKKQ3X.js";
import {
  supportsScrollBehavior
} from "./chunk-WSZNNRDU.js";
import {
  BidiModule,
  Directionality
...
var OverlayRef = class {
  ...
  _detachContentWhenEmpty() {
    this._ngZone.runOutsideAngular(() => {
      const subscription = this._renders.pipe((0, import_operators.takeUntil)((0, import_rxjs2.merge)(this._attachments, this._detachments))).subscribe(() => {
...
var MatSelect = class _MatSelect {
  ...
  _initialized = new import_rxjs6.Subject();
  _cleanupDetach;
  ...
  _destroy = new import_rxjs6.Subject();
  ...
  optionSelectionChanges = (0, import_rxjs6.defer)(() => {
    const options = this.options;
    if (options) {
      return options.changes.pipe((0, import_operators3.startWith)(options), (0, import_operators3.switchMap)(() => (0, import_rxjs6.merge)(...options.map((option) => option.onSelectionChange))));
    }
  ...
  _resetOptions() {
    const changedOrDestroyed = (0, import_rxjs6.merge)(this.options.changes, this._destroy);
    ...
    (0, import_rxjs6.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators3.takeUntil)(changedOrDestroyed)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
      this.stateChanges.next();
    });
  }
